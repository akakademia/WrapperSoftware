...
public enum MenuType {
	...
	ADMIN("Admin menü"), CATEGORIS_FOR_DATE_CHANGE("Adatmódosítási menü"), PRODUCTS_LIST_FOR_DATE_CHANGE("Terméklista menü"), FIELDS_FOR_DATE_CHANGE("Termék adatmódosítási menü"),
	...
	public String[] getBasicFields(MenuType menuType) {
		switch (menuType) {
		case ENTER:
			return new String[] { "Adminisztrátor", "Felhasználó" };
		case ADMIN:
			return new String[] { "Tovább számításhoz", "Adatmódosítás" };
		case CATEGORIS_FOR_DATE_CHANGE:
